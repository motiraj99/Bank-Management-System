...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        ButtonGroup g_acc = new ButtonGroup();
        g_acc.add(r1);
        g_acc.add(r2);
        g_acc.add(r3);
        g_acc.add(r4);
        ...
        p_number.setFont(new Font("Railway", Font.BOLD, 22));
        ...
        c7 = new JCheckBox("I hereby declare that the above entered details are correct to best of my information.");
